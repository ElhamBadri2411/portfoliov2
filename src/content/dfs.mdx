...
5. Create a [developer experience so good](https://leerob.io/blog/developer-experience-examples) that it does marketing for you. Write docs worth sharing, filled with helpful diagrams and detailed descriptions. Create code examples and templates that help developers get started quickly.
...
[Developer Relations](/blog/devrel-at-vercel) is more than only developer marketing. It's the intersection between product, engineering, marketing, and sales.
